package cn.coderstory.springboot.service.seckill.impl;
...
import cn.coderstory.springboot.entity.seckill.SeckillReservation;
...
import cn.coderstory.springboot.mapper.seckill.SeckillReservationMapper;
...
public class PreheatServiceImpl implements PreheatService {
    ...
    public Map<String, Object> getPreheatStatus(Long activityId) {
        ...
        status.put("reservationCount", count != null ? count : 0L);
