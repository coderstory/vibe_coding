...
public class RocketMQDashboardController {
     ...
     */
    @GetMapping("/brokers")
    public ResponseEntity<Map<String, Object>> getBrokerStatusList() {
     ...
     */
    @GetMapping("/topics")
    public ResponseEntity<Map<String, Object>> getTopicBacklogList() {
    ...
    public ResponseEntity<Map<String, Object>> getBrokerMetrics(@PathVariable String brokerName) {
