...
<!-- For checkpoint task examples and patterns, see @D:/Data/桌面/vibe_coding/.opencode/get-shit-done/references/checkpoints.md -->
...
See `D:/Data/桌面/vibe_coding/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Data/桌面/vibe_coding/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Data/桌面/vibe_coding/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
