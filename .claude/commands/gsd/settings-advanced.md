...
<execution_context>
@D:/Data/桌面/vibe_coding/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@D:/Data/桌面/vibe_coding/.claude/get-shit-done/workflows/settings-advanced.md`.
