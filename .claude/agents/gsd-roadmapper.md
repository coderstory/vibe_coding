...
Reference full template: `D:/Data/桌面/vibe_coding/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Data/桌面/vibe_coding/.claude/get-shit-done/templates/state.md`.
