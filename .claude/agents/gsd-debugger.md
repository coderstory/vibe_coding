...
<required_reading>
@D:/Data/桌面/vibe_coding/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Data/桌面/vibe_coding/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Data/桌面/vibe_coding/.claude
                  → checks D:/Data/桌面/vibe_coding/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Data/桌面/vibe_coding/.claude/get-shit-done
                  → writes to D:/Data/桌面/vibe_coding/.claude/get-shit-done/hooks/
...
@D:/Data/桌面/vibe_coding/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Data/桌面/vibe_coding/.claude/get-shit-done/references/common-bug-patterns.md
