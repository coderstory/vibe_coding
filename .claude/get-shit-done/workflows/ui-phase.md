...
```markdown
Read D:/Data/桌面/vibe_coding/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Data/桌面/vibe_coding/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Data/桌面/vibe_coding/.claude/agents/gsd-ui-checker.md for instructions.
