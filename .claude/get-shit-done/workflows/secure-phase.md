...
```
Task(
  prompt="Read D:/Data/桌面/vibe_coding/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Data/桌面/vibe_coding/.claude/get-shit-done/templates/SECURITY.md`
