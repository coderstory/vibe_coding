...
```bash
INIT=$(node "D:/Data/桌面/vibe_coding/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Data/桌面/vibe_coding/.claude/get-shit-done/templates/spec.md.
