...
INSTALL_JS_GLOBAL="D:/Data/桌面/vibe_coding/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Data/桌面/vibe_coding/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
