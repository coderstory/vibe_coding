...
## Current Milestone: v1.4 后端 Maven 到 Gradle 迁移

**Goal:** 将 Spring Boot 后端项目从 Maven 构建系统迁移到 Gradle，功能保持不变

**Target features:**
- 后端项目 Maven → Gradle 完整迁移
- 所有依赖和插件等效转换
- 构建脚本优化（Kotlin DSL 或 Groovy DSL）
- 保持现有功能完全正常工作
...
---
*Last updated: 2026-04-29 after v1.4 milestone started*
