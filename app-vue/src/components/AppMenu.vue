...
/* 只在顶级菜单项显示激活样式 */
.app-menu > li.el-menu-item.is-active {
...
.app-menu > li.el-menu-item.is-active::before {
  content: '';
  position: absolute;
  left: 0;
  top: 50%;
...
.app-menu > li.el-menu-item.is-active .el-icon {
  color: #d97706;
}
...
.app-menu :deep(.el-sub-menu .el-menu-item.is-active::before) {
  content: '';
  position: absolute;
  left: 0;
  top: 50%;
